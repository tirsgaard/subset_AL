...
from src.dataset import ToySample1, BaseDataset, MNIST_manifold
...
init_model_manifold = lambda: NNLearner(problem, 128, 4, 2, classification_loss, lr = 0.001, n_epochs = 10, batch_size = 32)
init_model_global = lambda: NNLearner(problem, 128, 4, 10, classification_loss, lr = 0.001, n_epochs = 10, batch_size = 32)
